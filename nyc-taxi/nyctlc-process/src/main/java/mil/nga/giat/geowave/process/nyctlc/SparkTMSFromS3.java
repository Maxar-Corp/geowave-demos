	...
	public static void main(
		...
		for (int level = minLevel; level <= maxLevel; level++) {
			...
			final PairFunction<Tuple2<Long, Double>, Tuple3<Integer, Integer, Integer>, Tuple2<Long, Double>> keyWithTile = (
				...
				final Tuple3<Integer, Integer, Integer> tms = SparkKDE.getTileNumberFromCellIndex(
						t._1,
						numXPosts,
						numYPosts,
						myLevel);
			...
			final Function2<Double[][], Tuple2<Long, Double>, Double[][]> applyValueToMatrix = (
				...
				final Tuple3<Integer, Integer, Integer> tms = SparkKDE.getTileNumberFromCellIndex(
						...
						numYPosts,
						myLevel);
				final Tuple2<Integer, Integer> pos = SparkKDE.interpolatePosition(
						t._1,
						numXPosts,
						numYPosts,
						SparkKDE.tile2boundingBox(
								tms._2(),
								tms._3(),
								tms._1()));
				matrix[pos._1][pos._2] = t._2;
				return matrix;
			};
			...
			VoidFunction<Tuple2<Tuple3<Integer, Integer, Integer>, Double[][]>>
	{
		...
		private void writeImage(
			...
			try {
				...
				AmazonS3URI uri = new AmazonS3URI(
						url);
